...
<table align="center" width="100%" style="border-collapse: collapse; border: none;">
  <tr>
    ...
    <td width="50%" align="center" style="padding: 12px;">
      <a href="./estado_del_arte" style="text-decoration: none;">
        <blockquote style="margin: 0; padding: 20px; border-left: 5px solid #FF5722; background-color: #f9f9f9; border-radius: 10px;">
...
<div align="center">
  <sub>Proyecto de Robótica Médica — Asistencia y Salud</sub>
</div>
